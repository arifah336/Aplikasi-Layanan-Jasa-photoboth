...
<head>
  ...
  <title>About - PhotoBooth by Aurami</title>
...
<body class="min-h-screen flex flex-col justify-between" style="background-color: #faeee7; color: #33272a;">
  ...
  <section class="pt-10 px-6 pb-16 max-w-4xl mx-auto">
    <div class="text-center mb-10">
      ...
      <p class="text-lg" style="color: #594a4e;">Photobooth captures the best moments of memories. We created this app to bring that experience home 😉👌</p>
    </div>
    ...
    <div class="card bg-white shadow-xl p-6 md:p-10 space-y-6">
      ...
      <div>
        ...
        <div class="collapse collapse-plus mb-2" style="background-color: #c3f0ca;">
          <input type="checkbox" />
          <div class="collapse-title font-medium">
            Can I customize the photobooth strip?
          </div>
          <div class="collapse-content" style="color: #594a4e;">
        ...
        <div class="collapse collapse-plus mb-2" style="background-color: #c3f0ca;">
          <input type="checkbox" />
          <div class="collapse-title font-medium">
            Can I choose my preferred layout?
          </div>
          <div class="collapse-content" style="color: #594a4e;">
